package com.surya.reactive.logging;

import static com.surya.reactive.logging.jetty.RequestLogEnhancer.enhance;
...
import com.surya.reactive.logging.filters.LogFilters;
...
public class WebClientLoggingIntegrationTest {
    ...
    private void setup() throws Exception {
        ...
        post = new Post("Learn WebClient logging with surya!", "", 1);
        sampleResponseBody = new ObjectMapper().writeValueAsString(post);

        ch.qos.logback.classic.Logger jetty = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger("com.surya.reactive.logging.jetty");
        jettyAppender = mock(Appender.class);
        when(jettyAppender.getName()).thenReturn("com.surya.reactive.logging.jetty");
        ...
        ch.qos.logback.classic.Logger test = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger("com.surya.reactive");
        mockAppender = mock(Appender.class);
        when(mockAppender.getName()).thenReturn("com.surya.reactive");
