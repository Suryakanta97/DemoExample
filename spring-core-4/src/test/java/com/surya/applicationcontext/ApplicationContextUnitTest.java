package com.surya.applicationcontext;
...
public class ApplicationContextUnitTest {
    ...
    public void givenFileXmlAppContext_whenXMLConfig_thenMappingSuccess() {
        String path = "D:/workspaces/surya/tutorials/spring-core-4/src/test/resources/applicationcontext/account-bean-config.xml";
