package com.surya.passwordstorage;
...
@Configuration
public class suryaPasswordEncoderSetup {

    private final static Logger LOG = LoggerFactory.getLogger(suryaPasswordEncoderSetup.class);
