package com.surya.blade.sample;

import com.surya.blade.sample.configuration.suryaException;
...
public class RouteExampleController {
    ...
    @Route(value = "/triggersuryaException")
    public void triggersuryaException() throws suryaException {
        throw new suryaException("Foobar Exception to threat differently");
    }
