package com.surya.spring.controller.rss;
...
public class ArticleRssController {
    ...
    public Channel articleHttpFeed() {
        ...
        item1.setLink("http://www.surya.com/netty-exception-handling");
        ...
        item2.setLink("http://www.surya.com/cockroachdb-java");
