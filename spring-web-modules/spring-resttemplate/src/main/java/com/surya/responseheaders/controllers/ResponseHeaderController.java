package com.surya.responseheaders.controllers;
...
public class ResponseHeaderController {
    ...
    public String usingHttpServletResponse(HttpServletResponse response) {
        response.addHeader("surya-Example-Header", "Value-HttpServletResponse");
    ...
    public ResponseEntity<String> usingResponseEntityConstructor() {
        ...
        responseHeaders.set("surya-Example-Header", "Value-ResponseEntityContructor");
    ...
    public ResponseEntity<String> usingResponseEntityConstructorAndMultipleHeaders() {
        ...
        HttpHeaders responseHeaders = new HttpHeaders();
        responseHeaders.set("surya-Example-Header", "Value-ResponseEntityConstructorAndHeaders");
    ...
    public ResponseEntity<String> usingResponseEntityBuilder() {
        String responseHeaderKey = "surya-Example-Header";
    ...
    public ResponseEntity<String> usingResponseEntityBuilderAndHttpHeaders() {
        HttpHeaders responseHeaders = new HttpHeaders();
        responseHeaders.set("surya-Example-Header", "Value-ResponseEntityBuilderWithHttpHeaders");
        String responseBody = "Response with header using ResponseEntity (builder)";
