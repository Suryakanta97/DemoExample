package com.surya.jstl.controllers;

import com.surya.jstl.dbaccess.SQLConnection;
...
public class JSTLController {
    ...
    private void generateDummy(Connection connection) throws SQLException {
        ...
        preparedStatement.setString(1, "patrick@surya.com");
        ...
        preparedStatement.setString(1, "bfrank@surya.com");
