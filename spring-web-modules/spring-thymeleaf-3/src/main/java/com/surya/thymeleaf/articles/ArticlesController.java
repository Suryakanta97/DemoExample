package com.surya.thymeleaf.articles;
    ...
    private List<Article> fetchArticles() {
        return Arrays.asList(
          new Article(
            ...
            "https://www.surya.com/thymeleaf-in-spring-mvc"
          ),
          new Article(
            "Spring Boot CRUD Application with Thymeleaf",
            "https://www.surya.com/spring-boot-crud-thymeleaf"
          ),
          new Article(
            "Spring MVC Data and Thymeleaf",
            "https://www.surya.com/spring-mvc-thymeleaf-data"
          )
        );
    }
}
