...
/**
 * This is the test class for {@link com.surya.controller.controller.PassParametersController} class.
 * 09/09/2017
 *
 * @author Ahmet Cetin
 */
...
public class PassParametersControllerIntegrationTest {
    ...
    public void testPassParametersWithModel() throws Exception {
        ...
        //Validate attribute
        Assert.assertEquals(mv.getModelMap().get("message").toString(), "surya");
    }
