package com.surya.reactive.filters;
...
public class PlayerHandlerIntegrationTest {
    ...
    @Test
    public void whenPlayerNameIssurya_thenWebFilterIsApplied() {
        EntityExchangeResult<String> result = webTestClient.get().uri("/players/surya")
                .exchange()
                .expectStatus().isOk()
                .expectBody(String.class)
                .returnResult();

        assertEquals(result.getResponseBody(), "surya");
