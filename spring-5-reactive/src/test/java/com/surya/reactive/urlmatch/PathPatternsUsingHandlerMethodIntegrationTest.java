package com.surya.reactive.urlmatch;
...
import com.surya.reactive.Spring5ReactiveApplication;
import com.surya.reactive.controller.PathPatternController;
...
public class PathPatternsUsingHandlerMethodIntegrationTest {
    ...
    public void givenHandlerMethod_whenURLWithMultiplePathVariablesInSameSegment_then200() {
        ...
        client.get()
            ...
            .is2xxSuccessful()
            .expectBody()
            .equals("Two variables are var1=surya and var2=tutorial");
    }
