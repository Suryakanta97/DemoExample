package com.surya.reactive.responseheaders;
...
public class ResponseHeaderLiveTest {
    ...
    private static final String SERVICE_SINGLE_RESPONSE_HEADER = "surya-Example-Header";
    private static final String SERVICE_FILTER_RESPONSE_HEADER = "surya-Example-Filter-Header";
