...
public class AvroSchemaBuilder {
    ...
    public Schema createAvroHttpRequestSchema(){
        ...
        Schema clientIdentifier = SchemaBuilder.record("ClientIdentifier").namespace("com.surya.avro.model")
                .fields().requiredString("hostName").requiredString("ipAddress").endRecord();

        Schema avroHttpRequest = SchemaBuilder.record("AvroHttpRequest").namespace("com.surya.avro.model").fields()
