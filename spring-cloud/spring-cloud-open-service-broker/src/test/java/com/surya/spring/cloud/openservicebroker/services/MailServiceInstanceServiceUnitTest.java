...
import com.surya.spring.cloud.openservicebroker.mail.MailServiceInstance;
...
public class MailServiceInstanceServiceUnitTest {
    ...
    private static final String MAIL_DASHBOARD_URL = "http://localhost:8080/mail-dashboard/test@surya.com";
