package com.surya.spring.cloud.openservicebroker.services;

import com.surya.spring.cloud.openservicebroker.mail.MailService;
import com.surya.spring.cloud.openservicebroker.mail.MailServiceBinding;
...
import static com.surya.spring.cloud.openservicebroker.mail.MailService.PASSWORD_KEY;
import static com.surya.spring.cloud.openservicebroker.mail.MailService.URI_KEY;
import static com.surya.spring.cloud.openservicebroker.mail.MailService.USERNAME_KEY;
...
public class MailServiceInstanceBindingServiceUnitTest {
    ...
    private static final String MAIL_SERVICE_INSTANCE_ID = "test@surya.com";
    private static final String MAIL_SERVICE_BINDING_ID = "test";
    private static final String MAIL_SYSTEM_URL = "http://localhost:8080/mail-system/test@surya.com";
