package com.surya.spring.cloud.archaius.extraconfigs;
...
public class ArchaiusExtraConfigsLiveTest {
    ...
    private static Map<String, String> createExpectedArchaiusProperties() {
        ...
        map.put("surya.archaius.properties.one", "one FROM:application.properties");
        map.put("surya.archaius.properties.two", "two FROM:application.properties");
        map.put("surya.archaius.properties.three", "three FROM:extra.properties");
        map.put("surya.archaius.properties.four", "four FROM:other.properties");
        return map;
    }
