package com.surya.spring.cloud.archaius.dynamosources.config;
...
import com.surya.spring.cloud.archaius.dynamosources.dynamodb.ArchaiusProperties;
import com.surya.spring.cloud.archaius.dynamosources.dynamodb.ArchaiusPropertiesRepository;
...
public class ApplicationPropertiesConfigurations {
    ...
    private void initDatabase() {
        ...
        // Populate the table
        ArchaiusProperties property = new ArchaiusProperties("surya.archaius.properties.one", "one FROM:dynamoDB");
        ArchaiusProperties property3 = new ArchaiusProperties("surya.archaius.properties.three", "three FROM:dynamoDB");
