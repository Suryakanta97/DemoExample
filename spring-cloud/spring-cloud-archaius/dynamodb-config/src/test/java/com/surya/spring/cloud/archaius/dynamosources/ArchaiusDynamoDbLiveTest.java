package com.surya.spring.cloud.archaius.dynamosources;
...
public class ArchaiusDynamoDbLiveTest {
    ...
    private static Map<String, String> createExpectedArchaiusProperties() {
        ...
        map.put("surya.archaius.properties.one", "one FROM:dynamoDB");
        map.put("surya.archaius.properties.two", "two FROM:application.properties");
        map.put("surya.archaius.properties.three", "three FROM:dynamoDB");
        return map;
    }
