package com.surya.spring.cloud.archaius.zookeeperconfig;
...
public class ArchaiusZookeeperLiveTest {
    ...
    private static Map<String, String> createExpectedArchaiusProperties() {
        ...
        map.put("surya.archaius.properties.one", "one FROM:zookeeper");
        map.put("surya.archaius.properties.two", "two FROM:application.properties");
        map.put("surya.archaius.properties.three", "three FROM:zookeeper");
        return map;
    }
