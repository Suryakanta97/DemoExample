package com.surya.spring.cloud.archaius.zookeeperconfig.config;
...
public class ZookeeperConfigsInitializer {
    ...
    public void appReady(ApplicationReadyEvent event) throws Exception {
        String pathOne = APPLICATION_BASE_NODE_PATH + "/surya.archaius.properties.one";
        String valueOne = "one FROM:zookeeper";
        String pathThree = APPLICATION_BASE_NODE_PATH + "/surya.archaius.properties.three";
