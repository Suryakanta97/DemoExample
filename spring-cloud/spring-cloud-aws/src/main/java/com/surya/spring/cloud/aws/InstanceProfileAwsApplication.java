package com.surya.spring.cloud.aws;
...
import com.surya.spring.cloud.aws.s3.SpringCloudS3Service;

@Configuration
@EnableAutoConfiguration
@ComponentScan("com.surya.spring.cloud.aws.s3")
public class InstanceProfileAwsApplication {
    ...
    private static void setupResources() {
        bucketName = "surya-test-" + UUID.randomUUID()
            .toString();
        try {
