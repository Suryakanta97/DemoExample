package com.surya.springbean.naming;

import com.surya.springbean.naming.component.Cat;
import com.surya.springbean.naming.component.Dog;
import com.surya.springbean.naming.service.PetShow;
...
public class SpringBeanNamingUnitTest {
    ...
    void setUp() {
        ...
        context.scan("com.surya.springbean.naming");
        context.refresh();
    }
