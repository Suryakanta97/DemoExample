package com.surya.componentscan.springbootapp;
...
// @ComponentScan(basePackages = "com.surya.componentscan.springbootapp.animals")
// @ComponentScan ( excludeFilters = @ComponentScan.Filter(type=FilterType.REGEX,pattern="com\\.surya\\.componentscan\\.springbootapp\\.flowers\\..*"))
