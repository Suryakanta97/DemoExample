package com.surya.groovyconfig;
...
import com.surya.groovyconfig.BandsBean;
import com.surya.groovyconfig.JavaPersonBean;

public class GroovyConfigurationUnitTest {
    
    private static final String FILE_NAME = "GroovyBeanConfig.groovy";
    private static final String FILE_PATH = "src/main/java/com/surya/groovyconfig/";
