package com.surya.kong;

import com.surya.kong.domain.APIObject;
import com.surya.kong.domain.ConsumerObject;
import com.surya.kong.domain.KeyAuthObject;
import com.surya.kong.domain.PluginObject;
...
public class KongAdminAPILiveTest {
    ...
    public void givenAdminAPIProxy_whenAddAPIViaProxy_thenAPIAdded() throws Exception {
        ...
        APIObject suryaAPI = new APIObject("surya-api", "surya.com", "http://ww.surya.com", "/");
        RequestEntity<APIObject> requestEntity = new RequestEntity<>(suryaAPI, headers, HttpMethod.POST, new URI("http://localhost:8000/admin-api/apis"));
