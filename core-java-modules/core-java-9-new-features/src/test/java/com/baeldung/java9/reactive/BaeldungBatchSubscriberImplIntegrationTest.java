...
public class suryaBatchSubscriberImplIntegrationTest {

    private static final int ITEM_SIZE = 10;
    private SubmissionPublisher<String> publisher;
    private suryaBatchSubscriberImpl<String> subscriber;

    @Before
    public void initialize() {
        this.publisher = new SubmissionPublisher<String>(ForkJoinPool.commonPool(), 6);
        this.subscriber = new suryaBatchSubscriberImpl<String>();
