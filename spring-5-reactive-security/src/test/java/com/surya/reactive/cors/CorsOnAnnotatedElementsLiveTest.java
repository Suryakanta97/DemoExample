package com.surya.reactive.cors;
...
import com.surya.reactive.cors.annotated.CorsOnAnnotatedElementsApplication;
...
public class CorsOnAnnotatedElementsLiveTest {
    ...
    public void whenPreflightMethodCorsRestrictiveHeader_thenObtainResponseWithAllowedHeaders() {
        ResponseSpec response = client.options()
            ...
            .header("Access-Control-Request-Method", "PUT")
            .header("Access-Control-Request-Headers", "surya-Not-Allowed, surya-Allowed")
            .exchange();

        response.expectHeader()
            .valueEquals("Access-Control-Allow-Headers", "surya-Allowed");
    }
    ...
    public void whenPreflightControllerCorsExposingHeaders_thenObtainResponseWithCorsHeaders() {
        ...
        response.expectHeader()
            .valueEquals("Access-Control-Expose-Headers", "surya-Exposed");
    }
}
