...
import com.surya.reactive.cors.global.CorsGlobalConfigApplication;
...
public class CorsOnGlobalConfigLiveTest {
    ...
    public void whenPreflightAllowedDeleteEndpoint_thenObtainResponseWithCorsHeaders() {
        ResponseSpec response = client.options()
            ...
            .header("Access-Control-Request-Headers", "surya-Not-Allowed, surya-Allowed, surya-Other-Allowed")
            .exchange();
        ...
        response.expectHeader()
            .valueEquals("Access-Control-Allow-Headers", "surya-Allowed, surya-Other-Allowed");
        response.expectHeader()
