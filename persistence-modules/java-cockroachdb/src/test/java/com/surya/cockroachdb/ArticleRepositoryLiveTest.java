package com.surya.cockroachdb;

import com.surya.cockroachdb.domain.Article;
import com.surya.cockroachdb.repository.ArticleRepository;
...
public class ArticleRepositoryLiveTest {
    ...
    public void whenSelectingAllArticles_thenAllArticlesAreReturned() throws SQLException {
        ...
        Article article = new Article(UUID.randomUUID(), "Guide to CockroachDB in Java", "surya");
        articleRepository.insertArticle(article);

        article = new Article(UUID.randomUUID(), "A Guide to MongoDB with Java", "surya");
        articleRepository.insertArticle(article);
    ...
    public void whenInsertingTwoArticlesWithSamePrimaryKeyInASingleTransaction_thenRollback() throws SQLException {
        ...
        try {
            ...
            Article article = new Article(articleId, "Guide to CockroachDB in Java", "surya");
            articleRepository.insertArticle(article);

            article = new Article(articleId, "A Guide to MongoDB with Java", "surya");
            articleRepository.insertArticle(article);
