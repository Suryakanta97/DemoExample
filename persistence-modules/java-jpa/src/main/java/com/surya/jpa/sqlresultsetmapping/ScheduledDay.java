package com.surya.jpa.sqlresultsetmapping;

import javax.persistence.*;

@SqlResultSetMappings(value = {
    @SqlResultSetMapping(name = "ScheduleResult",
        classes = { @ConstructorResult(targetClass = com.surya.jpa.sqlresultsetmapping.ScheduledDay.class,
    ...
    @SqlResultSetMapping(name = "EmployeeScheduleResults",
                         entities = { @EntityResult(entityClass = com.surya.jpa.sqlresultsetmapping.Employee.class),
                                      @EntityResult(entityClass = com.surya.jpa.sqlresultsetmapping.ScheduledDay.class)
    }) })
