...
import com.surya.spring.data.couchbase2b.MultiBucketCouchbaseConfig;
import com.surya.spring.data.couchbase2b.MultiBucketIntegrationTestConfig;
 ...
 * 
 * 2.1- Buckets: named 'surya' and 'surya2'
 * 
 * 2.2- Security: users 'surya' and 'surya2'. Note: in newer versions an empty password is not allowed, then we have to change the passwords in the project)
 * 
 ...
 * function (doc) {
 *     if (doc.location &&
 *       doc._class == "com.surya.spring.data.couchbase.model.Campus") {
 ...
 * {@code
 * function (doc, meta) {
 *     if(doc._class == "com.surya.spring.data.couchbase.model.Campus") {
 *         emit(meta.id, null);
 *     }
 * }}
 *
