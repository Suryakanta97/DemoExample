package com.surya.spring.data.couchbase2b;

import java.util.Arrays;
import java.util.List;

import com.surya.spring.data.couchbase.model.Campus;
...
@Configuration
@EnableCouchbaseRepositories(basePackages = { "com.surya.spring.data.couchbase2b" })
public class MultiBucketCouchbaseConfig extends AbstractCouchbaseConfiguration {
    ...
    public static final String DEFAULT_BUCKET_NAME = "surya";
    ...
    public Bucket campusBucket() throws Exception {
        return couchbaseCluster().openBucket("surya2", "");
    }
