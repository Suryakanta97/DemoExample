...
@EnableJpaRepositories(basePackages = "com.surya.multipledb.dao.product", entityManagerFactoryRef = "productEntityManager", transactionManagerRef = "productTransactionManager")
@Profile("!tc")
public class PersistenceProductAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean productEntityManager() {
        ...
        em.setPackagesToScan("com.surya.multipledb.model.product");
