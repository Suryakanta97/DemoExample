...
@EnableJpaRepositories(basePackages = "com.surya.multipledb.dao.user", entityManagerFactoryRef = "userEntityManager", transactionManagerRef = "userTransactionManager")
@Profile("!tc")
public class PersistenceUserAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManager() {
        ...
        em.setPackagesToScan("com.surya.multipledb.model.user");
