package com.surya.hibernate.logging;
...
import com.surya.hibernate.logging.Employee;
...
public class HibernateLoggingIntegrationTest {
    ...
    public void whenAllEmployeesAreSelected_ThenSuccess() {
        Query<Employee> query = sessionFactory.openSession().createQuery("from com.surya.hibernate.logging.Employee", Employee.class);
