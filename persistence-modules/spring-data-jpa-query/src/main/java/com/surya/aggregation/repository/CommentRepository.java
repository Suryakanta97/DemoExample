package com.surya.aggregation.repository;

import com.surya.aggregation.model.Comment;
import com.surya.aggregation.model.custom.CommentCount;
import com.surya.aggregation.model.custom.ICommentCount;
...
public interface CommentRepository extends JpaRepository<Comment, Integer> {
    ...
    @Query("SELECT new com.surya.aggregation.model.custom.CommentCount(c.year, COUNT(c.year)) FROM Comment AS c GROUP BY c.year ORDER BY c.year DESC")
