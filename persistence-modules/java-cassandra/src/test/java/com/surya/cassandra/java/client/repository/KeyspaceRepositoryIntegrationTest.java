package com.surya.cassandra.java.client.repository;
...
import com.surya.cassandra.java.client.CassandraConnector;
...
public class KeyspaceRepositoryIntegrationTest {
    ...
    public void whenCreatingAKeyspace_thenCreated() {
        String keyspaceName = "testsuryaKeyspace";
        schemaRepository.createKeyspace(keyspaceName, "SimpleStrategy", 1);

        // ResultSet result = session.execute("SELECT * FROM system_schema.keyspaces WHERE keyspace_name = 'testsuryaKeyspace';");
