package com.surya.jooq.springboot;

import static com.surya.jooq.introduction.db.public_.tables.Author.AUTHOR;
import static com.surya.jooq.introduction.db.public_.tables.AuthorBook.AUTHOR_BOOK;
import static com.surya.jooq.introduction.db.public_.tables.Book.BOOK;
...
import com.surya.jooq.introduction.PersistenceContextIntegrationTest;
...
public class SpringBootIntegrationTest {
    ...
    public void givenValidData_whenUpdating_thenSucceed() {
        ...
        assertEquals("surya", result.getValue(0, AUTHOR.LAST_NAME));
