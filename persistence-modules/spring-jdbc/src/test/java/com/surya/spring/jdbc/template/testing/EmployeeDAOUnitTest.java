package com.surya.spring.jdbc.template.testing;
...
public class EmployeeDAOUnitTest {
    ...
    public void setup() {
        dataSource = new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2)
          ...
          .addScript("classpath:com/surya/spring/jdbc/template/testing/schema.sql")
          .addScript("classpath:com/surya/spring/jdbc/template/testing/test-data.sql")
          .build();
    }
