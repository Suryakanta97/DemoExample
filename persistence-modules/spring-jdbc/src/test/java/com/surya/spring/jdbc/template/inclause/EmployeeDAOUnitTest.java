package com.surya.spring.jdbc.template.inclause;
...
public class EmployeeDAOUnitTest {
    ...
    public void setup() {
        dataSource = new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2)
          ...
          .addScript("classpath:com/surya/spring/jdbc/template/inclause/schema.sql")
          .addScript("classpath:com/surya/spring/jdbc/template/inclause/test-data.sql")
          .build();
    }
