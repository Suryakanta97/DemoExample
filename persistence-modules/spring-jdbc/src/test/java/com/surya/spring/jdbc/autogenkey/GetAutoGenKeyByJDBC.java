package com.surya.spring.jdbc.autogenkey;
...
import com.surya.spring.jdbc.autogenkey.repository.MessageRepositoryJDBCTemplate;
import com.surya.spring.jdbc.autogenkey.repository.MessageRepositorySimpleJDBCInsert;

@RunWith(SpringRunner.class)
public class GetAutoGenKeyByJDBC {

    @Configuration
    @ComponentScan(basePackages = {"com.surya.spring.jdbc.autogenkey"})
