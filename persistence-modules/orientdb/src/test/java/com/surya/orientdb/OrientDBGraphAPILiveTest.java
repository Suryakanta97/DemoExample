...
public class OrientDBGraphAPILiveTest {
    ...
    public static void setup() {
        ...
        graph = new OrientGraphNoTx("plocal:" + orientDBFolder + "/databases/suryaDB", "admin", "admin");
    }
    ...
    // @Test
    public void givensuryaDB_checkWeHaveThreeRecords() {
    ...
    // @Test
    public void givensuryaDB_checkWeHaveTwoWriters() {
    ...
    // @Test
    public void givensuryaDB_getEditorWithLevelSeven() {
        String onlyEditor = "";
