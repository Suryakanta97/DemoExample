...
import com.surya.hibernate.cache.model.Bar;
import com.surya.hibernate.cache.model.Foo;
import com.surya.hibernate.cache.service.FooService;
...
public class SecondLevelCacheIntegrationTest {
    ...
    public final void givenEntityIsLoaded_thenItIsCached() {
        ...
        final int size = CacheManager.ALL_CACHE_MANAGERS.get(0).getCache("com.surya.hibernate.cache.model.Foo").getSize();
