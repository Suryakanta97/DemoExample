package com.surya.hibernatesearch;
...
@EnableJpaRepositories(basePackages = { "com.surya.hibernatesearch" })
@ComponentScan({ "com.surya.hibernatesearch" })
public class HibernateSearchConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.surya.hibernatesearch.model" });
