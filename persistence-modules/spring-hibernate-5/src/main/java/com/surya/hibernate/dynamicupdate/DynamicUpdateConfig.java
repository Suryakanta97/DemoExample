...
@EnableJpaRepositories(basePackages = { "com.surya.hibernate.dynamicupdate" })
@ComponentScan({ "com.surya.hibernate.dynamicupdate" })
public class DynamicUpdateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.surya.hibernate.dynamicupdate.model" });
