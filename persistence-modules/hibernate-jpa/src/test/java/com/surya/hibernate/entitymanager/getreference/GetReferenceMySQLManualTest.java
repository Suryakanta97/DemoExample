package com.surya.hibernate.entitymanager.getreference;
...
/**
 * We need to have a running MySQL instance and a schema named "surya" ready in order to execute this integration test
 */
public class GetReferenceMySQLManualTest {
    ...
    public static void setup() {
        ...
        entityManagerFactory = Persistence.createEntityManagerFactory("com.surya.hibernate.entitymanager.game_player_mysql");
    }
