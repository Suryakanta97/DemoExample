...
import com.surya.hibernate.onetoone.jointablebased.Employee;
import com.surya.hibernate.onetoone.jointablebased.WorkStation;
...
public class HibernateOneToOneAnnotationJTBasedIntegrationTest {
    ...
    public void givenData_whenInsert_thenCreates1to1relationship() {
        ...
        employee.setName("bob@surya.com");
    ...
    private void assert1to1InsertedData() {
        ...
        assertEquals("bob@surya.com", employee.getName());
