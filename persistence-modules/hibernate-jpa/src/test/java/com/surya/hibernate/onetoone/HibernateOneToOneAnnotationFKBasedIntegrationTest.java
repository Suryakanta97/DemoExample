...
import com.surya.hibernate.onetoone.foreignkeybased.Address;
import com.surya.hibernate.onetoone.foreignkeybased.User;
...
public class HibernateOneToOneAnnotationFKBasedIntegrationTest {
    ...
    public void givenData_whenInsert_thenCreates1to1relationship() {
        User user = new User();
        user.setUserName("alice@surya.com");
    ...
    private void assert1to1InsertedData() {
        ...
        assertEquals("alice@surya.com", user.getUserName());
