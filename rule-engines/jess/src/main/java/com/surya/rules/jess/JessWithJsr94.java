package com.surya.rules.jess;

import com.surya.rules.jess.model.Answer;
import com.surya.rules.jess.model.Question;
...
public class JessWithJsr94 {
    ...
    public static final String RULES_URI = "com/surya/rules/bonus";
