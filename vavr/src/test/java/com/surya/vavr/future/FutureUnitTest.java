...
public class FutureUnitTest {
    ...
    private static final String HELLO = "Welcome to surya!";
    ...
    public void whenCallMap_thenCorrect() {
        Future<String> futureResult = Future.of(() -> "from surya")
          .map(a -> "Hello " + a)
          .await();

        assertThat(futureResult.get())
          .isEqualTo("Hello from surya");
    }
