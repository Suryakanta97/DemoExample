...
public class EmailServiceUnitTest {
    ...
    public void whenUsingArgumentMatcherForValidCredentials_expectTrue() {
        Credentials credentials = new Credentials("surya", "correct_password", "correct_key");
    ...
    public void whenNotAuthenticated_expectFalse() {
        Credentials credentials = new Credentials("surya", "incorrect_password", "incorrect_key");
