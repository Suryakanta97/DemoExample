...
@PrepareForTest(fullyQualifiedNames = "com.surya.powermockito.introduction.*")
public class PowerMockitoUnitTest {
    ...
    public void givenFinalMethods_whenUsingPowerMockito_thenCorrect() throws Exception {
        ...
        when(collaborator.helloMethod()).thenReturn("Hello surya!");
        String welcome = collaborator.helloMethod();
        verify(collaborator).helloMethod();
        assertEquals("Hello surya!", welcome);
    }
    ...
    public void givenStaticMethods_whenUsingPowerMockito_thenCorrect() {
        ...
        when(CollaboratorWithStaticMethods.firstMethod(Mockito.anyString())).thenReturn("Hello surya!");
        ...
        assertEquals("Hello surya!", firstWelcome);
        assertEquals("Hello surya!", secondWelcome);
