...
import com.surya.filter.RequestValidatorFilter;
import com.surya.handler.EmployeeHandler;
import com.surya.handler.RedirectHandler;
import com.surya.model.Employee;
import com.surya.repository.EmployeeRepository;
import com.surya.repository.EmployeeRepositoryImpl;
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Action<HikariConfig> hikariConfigAction = hikariConfig -> {
            ...
            hikariConfig.addDataSourceProperty("URL", "jdbc:h2:mem:surya;INIT=RUNSCRIPT FROM 'classpath:/DDL.sql'");
        };
        ...
        final Action<Chain> chainAction = chain -> chain.all(new RequestValidatorFilter())
            .get(ctx -> ctx.render("Welcome to surya ratpack!!!"))
