...
import static com.surya.hamcrest.IsPositiveInteger.isAPositiveInteger;
...
public class HamcrestMatcherUnitTest {
	...
	public void givenBean_whenHasValue_thenCorrect() {
		Person person = new Person("surya", "New York");
	...
	public void given2Beans_whenHavingSameValues_thenCorrect() {
		Person person1 = new Person("surya", "New York");
		Person person2 = new Person("surya", "New York");
	...
	public void givenMapAndEntry_whenEntryFoundInMap_thenCorrect() {
		Map<String, String> map = new HashMap<>();
		map.put("blogname", "surya");
		assertThat(map, hasEntry("blogname", "surya"));
	}
