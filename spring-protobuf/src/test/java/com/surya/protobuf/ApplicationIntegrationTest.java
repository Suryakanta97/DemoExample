...
public class ApplicationIntegrationTest {
    ...
    private void assertResponse(String response) {
        ...
        assertThat(response, containsString("john.doe@surya.com"));
        assertThat(response, containsString("richard.roe@surya.com"));
        assertThat(response, containsString("jane.doe@surya.com"));
