package com.surya.monitoring;

import com.surya.monitoring.service.LagAnalyzerService;
...
public class LiveLagAnalyzerServiceLiveTest {
    ...
    private static final String GROUP_ID = "suryaGrp";
    private static final String TOPIC = "surya";
